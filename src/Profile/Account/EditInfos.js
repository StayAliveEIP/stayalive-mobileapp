...
export function EditInfosMenu(props) {
  ...
  const textValue = props.variable && props.variable[props.indexVariable] !== null
  ...
  const calculateFontSize = () => {
    ...
    return isNaN(calculatedSize) ? baseFontSize : Math.max(minFontSize, calculatedSize);
  };
